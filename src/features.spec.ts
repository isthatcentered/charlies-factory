...
describe( `factory()`, () => {
	...
	describe( `Data generator`, () => {
		...
		test( `Each generated item has a "per factory" ID (each factory has it's own id sequence)`, () => {
			const makeThing      = factory( ( faker, id ) => ({ ...BLUEPRINT, id }) ),
			      makeOtherThing = factory( ( faker, id ) => ({ ...BLUEPRINT, id }) )
