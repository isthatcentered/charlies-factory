...
describe( `factory()`, () => {
	...
	describe( `Data generator`, () => {
		...
		test( `Item's id is passed to generator`, () => {
		fail()
		} )
		
		test( `Id incrementation is made perfactory`, () => {
			// exp makeTHing().id tobe 0
			// exp makeTHing().id tobe 1
			// exp makeOtherTHing().id tobe 0
			// exp makeOtherTHing().id tobe 1
		} )
	} )
